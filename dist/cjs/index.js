...
const CvDownload = ({ size, label, color, buttonHover, labelColor, linkUrl }) => {
    const styleProps = {
...
const ResponsiveNav = ({ logo, height, width, logoHeight, logoMargin, menuItemsArray, primaryColor, secondaryColor, hoverColor, pressColor, labelColor }) => {
    ...
    return (jsxRuntime.jsxs("section", { id: 'primary-header', className: 'primary-header flex-row', style: stylesProps, children: [jsxRuntime.jsx("div", { children: logo && jsxRuntime.jsx("img", { src: logo, className: 'primary-logo' }) }), jsxRuntime.jsx(ToggleButton, { top: 1, right: 1, customClass: 'mobile-nav-toggle', ariaControls: 'primary-navigation', ariaExpanded: false, setActive: () => { }, buttonBackgroundColor: 'transparent' }), jsxRuntime.jsx("nav", { children: jsxRuntime.jsx("ul", { id: 'primary-navigation', "data-visible": 'false', className: 'primary-navigation uppercase ff-sans-cond flex-row', children: menuItemsArray &&
                        menuItemsArray.map((item, index) => (jsxRuntime.jsx("li", { className: 'responsiveNav-active', children: jsxRuntime.jsxs("a", { className: 'responsiveNav-link', href: item.link, children: [jsxRuntime.jsxs("span", { "aria-hidden": 'true', children: ["0", index] }), item.label] }) }, `${item.label}-${index}`))) }) })] }));
};
