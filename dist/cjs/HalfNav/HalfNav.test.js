...
describe('HalfNav component', function () {
    var props = {
        menuItemsArray: MenuProps_1.menuItemsArray,
    };
    var renderComponent = function () { return (0, react_1.render)((0, jsx_runtime_1.jsx)(HalfNav_1.HalfNav, __assign({}, props))); };
    it('should match snapshots', function () {
        var container = renderComponent().container;
        expect(container).toMatchSnapshot();
    });
});
//# sourceMappingURL=HalfNav.test.js.map