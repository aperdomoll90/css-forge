...
export const ResponsiveNav: React.FC<ResponsiveNavPropsTypes> = ({
  logo,
  height,
  width,
  logoHeight,
  ...
  const renderMenuItems = menuItemsArray?.map(
    (item: menuItemsArrayPropsTypes, index: number) => (
  ...
  return (
    <section
      id="primary-header"
      className="primary-header flex-row"
