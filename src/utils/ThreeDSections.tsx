...
const Section: React.FC<SectionPropsType> = ({ children,state, offset, factor, ...props }) => {
  const { offset: parentOffset, sectionHeight, aspect } = useSection(state)
...
function useSection(state:StatePropsType) {
